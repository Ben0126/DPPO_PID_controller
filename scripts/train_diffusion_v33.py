...
def train(args):
    ...
    # Reuse v3.1 auxiliary-loss weights — only the data source changed.
    ...
    # num_workers=0: same rationale as v3.1 — data is memmapped, workers would
    # duplicate state and blow up memory on Windows spawn.
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, (img_stack, action_seq, imu, depth_gt) in enumerate(dataloader):
            ...
            # On-GPU brightness + contrast jitter (same as v3.1)
            B = img_stack.shape[0]
